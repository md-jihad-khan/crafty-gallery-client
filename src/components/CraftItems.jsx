  ...
  return (
    <div className="md:my-20 my-14 container mx-auto">
      <div className="text-center mb-10">
        <div className="flex items-center justify-center gap-3 text-5xl mb-2 mt-3 font-rancho font-bold">
        ...
        <p className="text-sm font-extralight md:w-2/3 mx-auto text-gray-400">
